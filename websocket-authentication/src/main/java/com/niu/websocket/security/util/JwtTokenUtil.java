package com.niu.websocket.security.util;
 ...
 * {"sub":"niu","created":1489079981393, "exp":1489684781}
 * <p>
 * signature的生成算法：
...
public class JwtTokenUtil {
     ...
     * @param validSub 主题
     */
    public boolean validateToken(String token, String validSub) {
        String tokenSub = getSubFromToken(token);
        return StrUtil.equals(tokenSub, validSub) && !isTokenExpired(token);
    }
